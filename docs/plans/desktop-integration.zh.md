...
| P2.5 真机验证 | 已完成 | 2026-09-07 | [notes/verification-integration.zh.md](notes/verification-integration.zh.md)：模型驱动项（C1–C4 真实触发）因无 key 标注"待复验/步骤"；原语与装配面（桥/CDP、roster、免打扰、无桥、文案）行为面已验证 |
