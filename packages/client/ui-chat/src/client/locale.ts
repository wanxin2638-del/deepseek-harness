...
export const zh = {
  'view.chat': '对话',
  'view.context': '上下文',
  'context.title': '当前模型上下文',
  'context.refresh': '刷新上下文',
  'context.loading': '正在读取上下文…',
  'context.empty': '当前会话还没有可用的模型上下文',
  'context.error': '上下文读取失败：{message}',
  'context.asOf': '日志位置 {seq}',
  'json.copyValue': '复制值',
...
export const en = {
  ...
  'context.title': 'Current model context',
  'context.refresh': 'Refresh context',
  'context.loading': 'Reading context…',
  'context.empty': 'This Session has no model context yet',
  'context.error': 'Context read failed: {message}',
  'context.asOf': 'Log position {seq}',
