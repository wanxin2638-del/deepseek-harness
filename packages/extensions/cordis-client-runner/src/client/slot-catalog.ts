...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.session.header.tabs.trailing',
    kind: 'list',
    scope: 'session',
    summary: 'Actions rendered immediately after the Session View tabs.',
    doc: 'Actions rendered immediately after the Session View tabs.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-permission-presets AuthorizedPaths id \'sandbox-roots\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.session.header.tabs.trailing\', () => ctx.slots.register(\n      { name: \'conversation.session.header.tabs.trailing\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-chat ContextView id \'context\'',
